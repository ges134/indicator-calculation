...
class TestIndependance(TestCase):
    ...
    def test_apply_pca_on_indicators(self):
        ...
        expected_eigenvectors = [
            [0.541, -0.436, 0.571, 0.091, -0.321, 0.283],
            [-0.350, -0.236, -0.006, 0.744, 0.302, 0.421],
            [0.193, -0.344, 0.214, 0.053, 0.662, -0.599],
            [0.136, 0.696, 0.405, 0.491, -0.105, -0.283],
            [0.145, 0.377, 0.268, -0.356, 0.587, 0.543],
            [0.713, 0.099, -0.626, 0.260, 0.113, 0.098]
        ]
